defmodule SubmitBlock.Transaction.Hash do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> SubmitBlock.Transaction.Hash.transaction_hash(%SubmitBlock.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<>>, value: 5, init: <<1>>})
      <<127, 113, 209, 76, 19, 196, 2, 206, 19, 198, 240, 99, 184, 62, 8, 95, 9, 122, 135, 142, 51, 22, 61, 97, 70, 206, 206, 39, 121, 54, 83, 27>>

      iex> SubmitBlock.Transaction.Hash.transaction_hash(%SubmitBlock.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<1>>, value: 5, data: <<1>>})
      <<225, 195, 128, 181, 3, 211, 32, 231, 34, 10, 166, 198, 153, 71, 210, 118, 51, 117, 22, 242, 87, 212, 229, 37, 71, 226, 150, 160, 50, 203, 127, 180>>

      iex> SubmitBlock.Transaction.Hash.transaction_hash(%SubmitBlock.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<1>>, value: 5, data: <<1>>}, 1)
  ...
  ## Examples
    ...
    iex> SubmitBlock.Transaction.Hash.sign_hash(<<2::256>>, <<1::256>>)
    {28,
    ...
    iex> SubmitBlock.Transaction.Hash.sign_hash(<<5::256>>, <<1::256>>)
    {27,
  ...
  def sign_hash(hash, private_key, chain_id \\ nil) do
    {:ok, {<<r::size(256), s::size(256)>>, recovery_id}} =
      ExSecp256k1.sign_compact(hash, private_key)
